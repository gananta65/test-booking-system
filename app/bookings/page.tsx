...
export default function BookingsPage() {
  ...
  const pastBookings = bookings.filter((b) => b.status !== "cancelled" && new Date(b.date) <= new Date())
  const cancelledBookings = bookings.filter((b) => b.status === "cancelled")

  const displayBookings =
    activeTab === "upcoming" ? upcomingBookings : activeTab === "past" ? pastBookings : cancelledBookings
                ...
                <CardContent className="pt-6">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                    <div>
                      ...
                      <p className="font-medium">{booking.barber.user.name}</p>
                    </div>
                    <div>
