      ...
      <main className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">Find and book appointments with your favorite barbers</p>
              <Button asChild>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">View and manage your upcoming appointments</p>
              <Button asChild>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">Set up your barber profile and services</p>
              <Button asChild>
